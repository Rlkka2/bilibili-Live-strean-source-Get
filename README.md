...
**CDN测速的方法不太准确可以使用**FFmpeg/ffprobe**拉取直播地址通过流量来判断是不是真流,反之流量低的可能是废流**
...
## 免责声明
1. 本项目仅用于个人技术学习，仅可在本人拥有完全权限的设备内测试。
2. 严禁未经授权扫描、访问、攻击任何第三方网络与设备。
3. 违规使用带来的全部法律责任与损失，均由使用者自行承担，作者不承担任何责任。
4. 下载、运行本项目即代表同意以上全部条款。
